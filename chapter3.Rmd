...
There is a positive and significant (though weak) relationship between students' age and high c=alcohol consumption, confirming the 2nd hypothesis.

There is no relationship between students' health and high alcohol consumption, rejecting the 3rd hypothesis. This is could be due to the fact that students are very younge, hence alcoholc consumption does not affect their health yet.
...
As the result shows now the predictive error of the model is smaller (~ 0.22), hence a better model. All the variables in this model are now significant. The relationships of these variables can be explaiend as follows:
